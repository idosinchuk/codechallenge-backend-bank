...
public class AccountServiceImplTest {
    ...
    public void shouldSaveAccount() {
        ...
        accountServiceImpl.updateAccount(accountDTO, transactionDTO);
    ...
    public void shouldThrowInsufficientBalanceException() {
        ...
        Assertions.assertThrows(InsufficientBalanceException.class, () -> accountServiceImpl.updateAccount(accountDTO, transactionDTO));
    }
